...
//    final private static String URL = "http://137.110.62.185:3000/users/register";
    ...
    final private static String API_SUBJECT_LIST = SERVER + "subjects/list";
    final private static String API_COURSE_LIST = SERVER + "courses/list";
    final private static String API_SECTION_LIST = SERVER + "sections/list";
    final private static String API_TOGETHER = SERVER + "togethers";
    ...
    public static InputStream postLoginInfo2 (List<NameValuePair> info) {
        try {
            // create HttpClient
            HttpClient httpclient = new DefaultHttpClient();

            HttpPost hpost = new HttpPost(API_USER_LOGIN);

            hpost.setEntity(new UrlEncodedFormEntity(info));
